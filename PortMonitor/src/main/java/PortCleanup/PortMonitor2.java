	...
	public static void main(String[] args) {
		...
		for (String device : devices) {
			...
			for (int i = 1; i < uniList.size(); i++) {
				cleanupUnis = pm2.validateUniForCleanup(uniList.get(i));
		...
		// print cleaned Uni List
		pm2.printCleanedUniList(CleanedUniList);
...
//			System.out.println("Response: " + sasiRes);
			...
			if (userComment.equals("CAN BE CLEANED!") || userComment.equals("CLEANED")
				...
				System.out.println("Todays date: " + LocalDate.now());// adjusting GMT to IST
...
//				System.out.println("Todays date: " + LocalDate.now());
				...
				LocalDate currentDate = LocalDate.now();// adjusting GMT to IST
